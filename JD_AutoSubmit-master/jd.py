...
class JD(object):
    ...
    def login(self):
        ...
        print (img.content)
        with open('D:\SRC\Python\Github\yanzhengma\\JD_AutoSubmit-master\\a.jpg', 'wb') as f:
            f.write(img.content)
...
if __name__ == '__main__':
    ...
    jd_user = "tomtubo"#input('请输入京东账号:')
    jd_pwd = "AAAsss111"#input('请输入京东密码:')
    rk_user = "tomtubo"#input('请输入若快账号:')
    rk_pwd = "AAAsss111"#input('请输入若快密码:')
